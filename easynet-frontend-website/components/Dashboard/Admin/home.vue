		...
		<div class="row">
			<div class="col-lg-12 col-xs-12 col-sm-12">
				<div class="alert alert-warning alert-dismissible fade show" role="alert">
					<strong>Hallo {{userdata.roles == '["ADMIN"]' ? 'Admin' : userdata.roles == '["STAFF"]' ? 'Staff' : 'Customer'}}</strong> Anda sedang login menggunakan email : {{userdata.email}}
...
<script>
	export default{
		props: ['userdata', 'userlogins', 'messagecount','loading']
	}
</script>